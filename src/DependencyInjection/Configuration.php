    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $tree->getRootNode()
            ->children()
                ...
                ->scalarNode('geowidget_token')->defaultValue('')->info('Token Geowidgetu (mapa paczkomatów) konta produkcyjnego — wydawany na domenę sklepu. Pusty = sama lista punktów.')->end()
                ->scalarNode('sandbox_geowidget_token')->defaultValue('')->info('Token Geowidgetu konta sandbox.')->end()
                ->enumNode('geowidget_config')->values(['parcelcollect', 'parcelcollect247', 'parcelcollectpayment', 'parcelsend'])->defaultValue('parcelcollect')->info('Zestaw punktów na mapie; parcelcollect247 = tylko całodobowe.')->end()
