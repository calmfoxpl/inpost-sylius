...
final class CalmfoxInPostExtension extends Extension implements PrependExtensionInterface
{
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        foreach (['api_token', 'organization_id', 'sandbox_api_token', 'sandbox_organization_id', 'geowidget_token', 'sandbox_geowidget_token', 'geowidget_config', 'sandbox', 'methods', 'sending_method', 'locker_template', 'courier_parcel', 'cod_payment_methods', 'points_cache_ttl'] as $key) {
